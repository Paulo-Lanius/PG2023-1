...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Triangulo Ponto Colorido (8-Lista1)! - Paulo Lanius", nullptr, nullptr);
...
int setupGeometry()
{
	...
	GLfloat vertices[] = {
		 0.0, 0.6, 0.0, //Ponto 1 - Vermelho
		-0.6,-0.6, 0.0, //Ponto 2 - Verde
		 0.6,-0.3, 0.0, //Ponto 3 - Azul
	};

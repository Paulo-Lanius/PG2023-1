...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Casa (9-Lista1)! - Paulo Lanius", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform4f(colorLoc, 0.66f, 0.66f, 0.66f, 1.0f);
		...
		glUniform4f(colorLoc, 0.175f, 0.088f, 0.016f, 1.0f);
		glDrawArrays(GL_TRIANGLE_FAN, 13, 4);

		// Porta
		glUniform4f(colorLoc, 0.605f, 0.305f, 0.0f, 1.0f);
